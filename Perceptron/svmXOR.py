# -*- coding: utf-8 -*-
"""
Created on Tue Jan  7 13:15:26 2020
...
#d = np.array([0, 1, 1, 0])
y=np.array(desired_output.flatten())
...
#y=np.array(prediction.flatten(),dtype=int)
print()
...
svm.fit(inputs, y) 
fig = plot_decision_regions(X=inputs, y=y, clf=svm, legend=2) 
plt.title("SVM XOR")
plt.show()